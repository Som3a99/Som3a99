...
<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&center=true&vCenter=true&width=435&lines=Software+%26+Electronics+Engineer;AI+%26+Computer+Vision+Enthusiast;Full-Stack+Developer;Always+learning+new+things" alt="Typing SVG" /></a>
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=som3a99&label=Profile%20views&color=0e75b6&style=flat" alt="som3a99" />
</p>
...
- 🎓 **Communication & Electronics Engineering** student with a passion for software
- 🏫 Studied **Software Engineering** at ALX / Holberton School
- 🎯 Completed **CS50x** - Harvard's Introduction to Computer Science
- 🤖 Focused on **AI, Machine Learning, Computer Vision & Data Science**
- 🌊 Building AI-powered underwater detection systems to support ocean cleanup
- 💼 Currently exploring **Full-Stack Development** with Flask and ASP.NET Core
- 📫 Reach me at **Mohamed_EMohamed@outlook.com**
- 📄 [View my Resume](https://drive.google.com/file/d/1yyHmErXiYHChin6y5ue6ocxIgqxteTtg/view?usp=drive_link)
...
|---------|-------------|------|
| [**NeptuneDetect**](https://github.com/Som3a99/NeptuneDetect) | AI-powered underwater object detection system supporting ROVs, ESP32-CAM, and uploaded media with real-time detection | Python, YOLO, Streamlit, OpenCV |
| [**DeepSeaVision**](https://github.com/Som3a99/DeepSeaVision) | ML solution to identify and classify trash in underwater environments for ocean cleanup | Python, TensorFlow, Jupyter |
| [**MemphisHubsPlatform**](https://github.com/Som3a99/MemphisHubsPlatform) | Demo Management Platform for LMS & ERP solutions with JWT Auth and role-based access control | C#, ASP.NET Core 8.0 |
| [**PortfolioCRM**](https://github.com/Som3a99/PortfolioCRM) | CRM system for portfolio management | C#, ASP.NET Core |
| [**company-management-system**](https://github.com/Som3a99/company-management-system) | Enterprise-style app for managing departments, employees, and internal workflows | C#, ASP.NET Core |
| [**e-commarce**](https://github.com/Som3a99/e-commarce) | CS50x graduation project - full e-commerce platform with user auth and product management | Python, Flask, HTML/CSS |
| [**AI_MasteryHub**](https://github.com/Som3a99/AI_MasteryHub) | Comprehensive tutorials, code snippets, and projects covering data analysis, visualization, and ML | Python, Jupyter, Pandas |
| [**AirBnB_clone**](https://github.com/Som3a99/AirBnB_clone) | Full-stack accommodation booking web app with user auth, booking management, and messaging | Python, Flask |
| [**AI_Project**](https://github.com/Som3a99/AI_Project) | Maze-solving implementation using AI search algorithms | Python, HTML |
| [**simple_shell**](https://github.com/Som3a99/simple_shell) | Custom Unix shell built from scratch as an ALX group project | C |
| [**Task-Manager-CLI**](https://github.com/Som3a99/Task-Manager-CLI) | Command-line task manager with persistent storage | Python |
